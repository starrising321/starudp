...
# URLs of GitHub
REPO_URL="https://github.com/starrising321/starudp"
API_BASE_URL="https://api.github.com/repos/starrising321/starudp"
				...
				if [[ -z "$_is_update_required" ]]; then
					...
					if [[ -z "$_is_update_required" ]]; then
						...
						if [[ -n "$_is_frash_install" ]]; then
							...
							echo -e "Follow me!"
							echo
							echo -e "\t+ Check out my website at $(tblue)https://www.limerise.be$(treset)"
							echo -e "\t+ Follow me on Telegram: $(tblue)https://t.me/star_jani$(treset)"
							echo -e "\t+ Follow me on Facebook: $(tblue)https://facebook.com/StarZanyGamer/$(treset)"
							echo
							else
								restart_running_services
